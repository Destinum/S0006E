...
/*void Rasterizer::RasterTriangle(Vertex First, Vertex Second, Vertex Third, void(*LambdaFunction)(int))
{
    
}*/
/*
void Rasterizer::RasterTriangle(Vertex First, Vertex Second, Vertex Third)
{
...
{
    auto Lambda = [](int value) {std::cout << value << endl;};
}




void RasterizerShader::Setup(const GLchar* PathToVertexShader, const GLchar* PathToFragmentShader)
{
    //Setup Vertex Shader
